<html>
    ...
    <body>
        ...
        <h1 style="background-image: url(../picture/background/background2.jpg);padding:2%;text-align: center;margin: 0px;color: black;">Competition</h1>
        <div style="display: flex; background-image:url('../picture/background/background.jpg');padding: 3% 5%;">
            ...
            $sql = "SELECT EventID,EventName,Picture_location,StartDate FROM event WHERE Category = 'Competitions'";   //display detail from database
