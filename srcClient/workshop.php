<html>
    ...
    <body>
        ...
        <!--workshop event container -->
        <h1 style="background-image: url('../picture/background/background2.jpg');padding:2%;text-align: center;margin: 0px;color: black;">Workshop Event</h1>
        <div style="display: flex; background-image:url('../picture/background/background.jpg');padding: 3% 5%;">
            ...
            $sql = "SELECT EventID,EventName,Picture_location,StartDate FROM event WHERE Category = 'Workshop'";
        ...
        <div style="background-color: #404040;padding-bottom: 4%;padding-top: 27px;">
            ...
            <div style="margin-left:3%;margin-right: 3%;">
                <div class="owl-carousel slide2">
                    <div>
                        <img src='../picture/workshop/album/album1.jpg'/>
                    </div>
                    <div>
                        <img src='../picture/workshop/album/album2.jpg'/>
                    </div>
                    <div>
                        <img src='../picture/workshop/album/album3.jpg'/>
                    </div>
                    <div>
                        <img src='../picture/workshop/album/album4.jpg'/>
                    </div> 
                    <div>
                        <img src='../picture/workshop/album/album5.jpg'/>
                    </div> 
                </div>
            </div>
        </div>  
