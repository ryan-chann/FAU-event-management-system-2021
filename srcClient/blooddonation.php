<html>
    <head>
        ...
        <title>FAU -Blood Donation</title>
    </head>
    <body>
        <!--navigation bar -->
        <?php
        ...
        <!--blood donation event container -->
        <h1 style="background-image: url(../picture/background/background2.jpg);padding:2%;text-align: center;margin:0px;color: black;">Blood Donation</h1>
        <div style="display: flex; background-image:url('../picture/background/background.jpg');padding: 3% 5%;">
            ...
            $sql = "SELECT EventID,EventName,Picture_location,StartDate FROM event WHERE Category = 'Blood Donation'"; //display detail from database
        ...
        <div style="background-color:#404040;padding-bottom: 4%;padding-top: 27px;">
            ...
            <div style="margin-left:3%;margin-right: 3%;">
                <div class="owl-carousel slide2">
                    <div>
                        <img src='../picture/blood_donation/album/album1.JPG'/>
                    </div>
                    <div>
                        <img src='../picture/blood_donation/album/album2.JPG'/>
                    </div>
                    <div>
                        <img src='../picture/blood_donation/album/album3.JPG'/>
                    </div>
                    <div>
                        <img src='../picture/blood_donation/album/album4.JPG'/>
                    </div>  
                    <div>
                        <img src='../picture/blood_donation/album/album5.JPG'/>
                    </div> 
                    <div>
                        <img src='../picture/blood_donation/album/album6.JPG'/>
                    </div> 
                </div>
            </div>
        </div>   
